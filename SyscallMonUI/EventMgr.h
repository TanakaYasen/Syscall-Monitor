...
public:
    ...
    ULONG GetClosestFunctionOffset(std::string &funcName);

    ULONG64 m_ReturnAddress;
    CUniqueModule *m_UniqueModule;
};

typedef std::vector<CCallStack> CCallStackList;
...
public:
    ...
    void CreateCallStacks(int kernelCaller, int userCaller, ULONG64 *callers);
    void FixCallStacks(bool bQueryUnknownMods);
...
protected:
    ...
    ULONG64 m_EventId;
public:
    USHORT m_KernelCallerCount, m_UserCallerCount;
...
public:
    ...
    virtual QString GetEventPath(void) const { return m_ImagePath.GetQString(); }
    virtual EventType_t GetEventType(void) const { return EV_LoadImage; }
    virtual EventClass_t GetEventClassify(void) const { return EVClass_PsNotify; }
    virtual void GetFullArgument(QString &str) const;
private:
    CUniqueString m_ImagePath;
	ULONG64 m_ImageBase;
    ULONG m_ImageSize;
};
...
public:
    ...
    virtual QString GetEventPath(void) const { return m_ModuleFile.GetQString(); }
...
public:
    ...
    void LoadFilters(const CFilterList &list);
    void GetFilters(CFilterList &list);
    void DumpToFile(const QString &Path);
    void SetConfig(const QString &Key, const QString &Val);
    void SetLuaFilter(const QString &code, bool save=false);
    bool filter_by_lua;
signals:
...
public slots:
    void OnCallStack(QSharedPointer<QByteArray> data);
    void OnPsCreateProcess(QSharedPointer<QByteArray> data);
    void OnPsCreateThread(QSharedPointer<QByteArray> data);
    void OnPsLoadImage(QSharedPointer<QByteArray> data);
    void OnNtLoadDriver(QSharedPointer<QByteArray> data);
    void OnNtQuerySystemInfo(QSharedPointer<QByteArray> data);
    void OnNtOpenProcess(QSharedPointer<QByteArray> data);
    void OnNtOpenThread(QSharedPointer<QByteArray> data);
    void OnNtTerminateProcess(QSharedPointer<QByteArray> data);
    void OnNtAllocateVirtualMemory(QSharedPointer<QByteArray> data);
    void OnNtReadWriteVirtualMemory(QSharedPointer<QByteArray> data);
    void OnNtProtectVirtualMemory(QSharedPointer<QByteArray> data);
    void OnNtQueryVirtualMemory(QSharedPointer<QByteArray> data);
    void OnNtCreateOpenMutant(QSharedPointer<QByteArray> data);
    void OnNtCreateOpenDirectoryObject(QSharedPointer<QByteArray> data);
    void OnNtQueryDirectoryObject(QSharedPointer<QByteArray> data);
    void OnNtUserSetWindowsHook(QSharedPointer<QByteArray> data);
    void OnNtUserFindWindow(QSharedPointer<QByteArray> data);
    void OnNtUserInternalGetWindowText(QSharedPointer<QByteArray> data);
    void OnNtUserGetClassName(QSharedPointer<QByteArray> data);
    void OnFsCreateFile(QSharedPointer<QByteArray> data);
    void OnFsCloseFile(QSharedPointer<QByteArray> data);
    void OnFsReadWriteFile(QSharedPointer<QByteArray> data);
    void OnFsCreateFileMapping(QSharedPointer<QByteArray> data);
    void OnFsQueryFileInformation(QSharedPointer<QByteArray> data);
    void OnRgCreateOpenKey(QSharedPointer<QByteArray> data);
    void OnRgSetValueKey(QSharedPointer<QByteArray> data);
    void OnRgQueryValueKey(QSharedPointer<QByteArray> data);
    void OnRgQueryKey(QSharedPointer<QByteArray> data);
};
